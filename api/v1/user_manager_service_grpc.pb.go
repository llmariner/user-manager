...
type UsersInternalServiceClient interface {
	...
	ListProjects(ctx context.Context, in *ListProjectsRequest, opts ...grpc.CallOption) (*ListProjectsResponse, error)
	ListProjectUsers(ctx context.Context, in *ListProjectUsersRequest, opts ...grpc.CallOption) (*ListProjectUsersResponse, error)
	CreateInternalUser(ctx context.Context, in *CreateInternalUserRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *usersInternalServiceClient) CreateInternalUser(ctx context.Context, in *CreateInternalUserRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/llmariner.users.server.v1.UsersInternalService/CreateInternalUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UsersInternalServiceServer interface {
	...
	ListProjects(context.Context, *ListProjectsRequest) (*ListProjectsResponse, error)
	ListProjectUsers(context.Context, *ListProjectUsersRequest) (*ListProjectUsersResponse, error)
	CreateInternalUser(context.Context, *CreateInternalUserRequest) (*emptypb.Empty, error)
...
func (UnimplementedUsersInternalServiceServer) CreateInternalUser(context.Context, *CreateInternalUserRequest) (*emptypb.Empty, error) {
...
func _UsersInternalService_CreateInternalUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateInternalUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UsersInternalServiceServer).CreateInternalUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/llmariner.users.server.v1.UsersInternalService/CreateInternalUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsersInternalServiceServer).CreateInternalUser(ctx, req.(*CreateInternalUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UsersInternalService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UsersInternalService_CreateInternalUser_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/v1/user_manager_service.proto",
