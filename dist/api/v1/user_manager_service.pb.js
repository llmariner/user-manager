...
export class UsersInternalService {
    ...
    static CreateInternalUser(req, initReq) {
        return fm.fetchReq(`/llmariner.users.server.v1.UsersInternalService/CreateInternalUser`, Object.assign(Object.assign({}, initReq), { method: "POST", body: JSON.stringify(req) }));
    }
}
